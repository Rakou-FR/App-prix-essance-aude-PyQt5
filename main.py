...
class Ui_MainWindow(object):
        ...
        def Castel(self):
                ...
                self.pushButton_2.setText(adresse[1] + prix_nom[1])
                self.pushButton_3.setText(adresse[2]+ prix_nom[2])
                self.pushButton_4.setText(adresse[3]+ prix_nom[3])
                self.pushButton_5.setText(adresse[4]+ prix_nom[4])
                self.pushButton_6.setText(adresse[5]+ prix_nom[5])
                self.pushButton_7.setText(adresse[6]+ prix_nom[6])
                self.pushButton_8.setText(adresse[7]+ prix_nom[7])
                self.pushButton_9.setText(adresse[8]+ prix_nom[8])
                self.pushButton_10.setText(adresse[9]+ prix_nom[9])
                self.pushButton_11.setText(adresse[10]+ prix_nom[10])
                self.pushButton_12.setText(adresse[11]+ prix_nom[11])
                self.pushButton_13.setText(adresse[12]+ prix_nom[12])
                self.pushButton_14.setText(adresse[13]+ prix_nom[13])
                self.pushButton_15.setText(adresse[14]+ prix_nom[14])
                self.pushButton_16.setText(adresse[15]+ prix_nom[15])
                self.pushButton_17.setText(adresse[16]+ prix_nom[16])
                self.pushButton_18.setText(adresse[17]+ prix_nom[17])
